<%-- 
    Document   : admin_subcomment
    Created on : Mar 17, 2019, 7:39:22 PM
    Author     : user
--%>
    ...
    <html>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("a[href='/dashboard/subcomment']").addClass("active");
                $("a[href='/dashboard/subcomment']").attr("href", "#!");
            });
            function ubahSC(idx){
//            $("select.slctSts").change(function(){
                $.post("/ChangeSubComment", {"kode" : idx}, function(){
